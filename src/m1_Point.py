...
class Point(object):
    ...
    def get_distance_from_start(self):
        ...
        point1 = Point(self.start_x, self.start_y)
        return self.get_distance_from(point1)

    def get_distance_traveled(self):
        return self.distance

    def closer_to(self, p2, p3):
        distance1 = math.sqrt((self.x-p2.x)**2 + (self.y-p2.y)**2)
        distance2 = math.sqrt((self.x-p3.x)**2 + (self.y-p3.y)**2)
    ...
    def halfway_to(self, p2):
        return (self.x + p2.x)/2, (self.y + p2.y)
...
def run_test_init():
    ...
    Tests the   __init__   method of the Point class.
      ...
      -- Note:  the   __init__  method when one constructs
